...
if (  ssh ${UN} '[ ! -d "karansheth" ]'); then
        ssh ${UN} mkdir -p karansheth/data
fi

if (  ssh ${PN} '[ ! -d "karansheth" ]'); then
        ssh ${PN} mkdir -p karansheth/data
fi
...
# To UN
UN_src_f_d="./"$main_core"/"$Pair_Code"/UN/demon_*.bash"
UN_src_f_p="./"$main_core"/"$Pair_Code"/UN/pingparser.py"


scp ${UN_src_f_d} ${UN}:~/karansheth/
scp ${UN_src_f_p} ${UN}:~/karansheth/


# TO PN 
PN_src_f_d="./"$main_core"/"$Pair_Code"/PN/demon_*.bash"
PN_src_f_p="./"$main_core"/"$Pair_Code"/PN/pingparser.py"


scp ${PN_src_f_d} ${PN}:~/karansheth/
scp ${PN_src_f_p} ${PN}:~/karansheth/
